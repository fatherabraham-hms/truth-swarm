#!/usr/bin/env python3
"""
Check if a specific agent exists on Agentverse with authentication
"""
...
async def check_agent_with_auth():
    """Check if the specific agent exists on Agentverse with auth"""
    
    agent_id = "agent1qw6r85pxdr6d9393jp5856g3he54a6pay8x96td55n0757su9nkvxxa0tac"
    api_key = os.getenv("AGENTVERSE_API_KEY")
    
    print("🔍 Checking agent with authentication")
    print("=" * 50)
    ...
    # Try different endpoints with auth
    endpoints = [
    ...
    # Also try to search for it in the agents list with auth
    print("🔍 Searching in agents list with auth...")
    try:
...
if __name__ == "__main__":
    asyncio.run(check_agent_with_auth())
