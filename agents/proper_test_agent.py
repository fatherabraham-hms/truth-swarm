#!/usr/bin/env python3
"""
Proper test agent that sends messages to your Agentverse agent using correct uAgents API
"""
...
test_agent = Agent(
    name="proper_test_agent",
    seed="proper_test_seed_2024",
    port=8007,
...
# Create a separate protocol for sending messages
sender_protocol = Protocol(name="sender_protocol", version="1.0")

@sender_protocol.on_interval(period=5.0)
