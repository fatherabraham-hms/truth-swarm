#!/usr/bin/env python3
"""
Final test agent that sends messages to your Agentverse agent
"""
...
@sender_protocol.on_interval(period=2.0)
...
def main():
    ...
    async def run_test():
        try:
            ...
            print("   Will send message in 2 seconds...")
