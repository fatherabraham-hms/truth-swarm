...
export interface DetailedEvaluation {
  ...
  metrics: {
    ...
    capabilities: EvaluationMetric;
    domain: EvaluationMetric;
  };
}

// Mock data for now
const mockEvaluationDetails = (cid: string): DetailedEvaluation => ({
...
export function useEvaluationDetails(detailsCID: string) {
  return useQuery<DetailedEvaluation>({
    ...
    queryFn: async () => {
      ...
      return mockEvaluationDetails(detailsCID);
    },
